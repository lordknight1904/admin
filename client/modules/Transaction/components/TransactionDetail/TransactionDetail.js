...
import { getDetail, getTransactionDetail, getConfirmations, getTxHash } from '../../TransactionReducer';
import { closeTransactionDetail } from '../../TransactionActions';
...
class TransactionDetail extends Component {
  ...
  render() {
    ...
    const bool = transactionDetail.txCoin === this.props.txHash;
